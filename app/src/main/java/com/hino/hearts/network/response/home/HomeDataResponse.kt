...
//    }
    ...
    data class Data(val userName: String, val monthlyVisit: Long, val totalOpportunity: Long, val todayVisit: ArrayList<TodayVisit>, val pendingApprovals: ArrayList<PendingApprovals>)
