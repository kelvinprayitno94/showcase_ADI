...
class HomeActivity : _root_ide_package_.com.showcase.movie.ui.BaseActivity<ActivityHomeBinding>(), AddVisitButtonAdapter.OnClick {
    ...
    private val viewModel by viewModel<_root_ide_package_.com.showcase.movie.ui.home.HomeViewModel>()
    ...
    override fun initEvent() {
        ...
        fl_close.onClick {
            ...
            }, _root_ide_package_.com.showcase.movie.ui.home.HomeActivity.Companion.TWO_HUNDREDS)
        }
...
//        }
    ...
    private fun initLayout() {
        ...
        addFragment(_root_ide_package_.com.showcase.movie.ui.home.HomeFragment())
        initOneSignal()
        ...
        when (viewModel.roleId.value == 7) {
            true -> {
                ...
                val gridLayoutManager = GridLayoutManager(this,
                    _root_ide_package_.com.showcase.movie.ui.home.HomeActivity.Companion.SIX
                )
                gridLayoutManager.spanSizeLookup = object : GridLayoutManager.SpanSizeLookup() {
                    override fun getSpanSize(i: Int): Int {
                        return _root_ide_package_.com.showcase.movie.ui.home.HomeActivity.Companion.TWO
                    }
                }
