 ...
 */
class HomeMenuAdapter(var listener: OnMenuTap) :
    RecyclerView.Adapter<HomeMenuAdapter.HomeViewHolder>() {
    ...
    override fun onBindViewHolder(holder: HomeViewHolder, position: Int) {
        holder.itemView.setOnClickListener { listener.onTap(mData[position].name) }
